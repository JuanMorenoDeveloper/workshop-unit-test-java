...
public class StringCalculatorUnitTest {
  ...
  @Test
  public void givenStringVacio_whenAdd_thenRetornoCero() throws IllegalArgumentException {
  ...
  @Test
  public void givenUnNumero_whenAdd_thenRetornoMismoNumero() throws IllegalArgumentException {
    StringCalculator calc = new StringCalculator();
  ...
  @Test
  public void givenDosNumeros_whenAdd_thenRetornoSuma() throws IllegalArgumentException {
    StringCalculator calc = new StringCalculator();
  ...
  public void givenListaNumeros_whenAdd_thenRetornoSuma(String input, int output) throws IllegalArgumentException {
    StringCalculator calc = new StringCalculator();
  ...
  @Test
  public void givenDosNumerosConSaltoDeLinea_whenAdd_thenRetornoSuma() throws IllegalArgumentException {
    StringCalculator calc = new StringCalculator();
  ...
  @Test
  public void givenTresNumerosConSaltoDeLinea_whenAdd_thenRetornoSuma() throws IllegalArgumentException {
    StringCalculator calc = new StringCalculator();
  ...
  @Test
  public void givenTresNumerosWithCustomDelimiter_whenAdd_thenRetornoSuma() throws IllegalArgumentException {
    StringCalculator calc = new StringCalculator();
  ...
  public void givenNumeroNegativo_whenAdd_thenThrowIllegalArgumentException(String input, String message) {
    StringCalculator calc = new StringCalculator();
  ...
  @Test
  public void givenNumerosMayoresAMil_whenAdd_thenRetornoSumaSinEllos() throws IllegalArgumentException {
    StringCalculator calc = new StringCalculator();
